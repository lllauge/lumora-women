  ...
  const quickLinks = [
    {
      ...
      body: 'Having trouble with a course or lesson? We\'ll get you sorted.',
    },
    {
      icon: <Mail size={22} strokeWidth={1.5} />,
      title: 'General Questions',
      body: 'Curious about Lumora Women, our programs, or how to get started?',
    },
    {
      icon: <Clock size={22} strokeWidth={1.5} />,
      title: '24-Hour Response',
      body: 'We respond to all messages within one business day. We promise.',
    },
  ]
  ...
  return (
    <main style={{ background: 'var(--warm-white)' }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '40rem', margin: '0 auto' }}>
          ...
          <p style={{
            ...
            Whether you have a question about a course, need account help, or just want
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '52rem', margin: '0 auto' }}>
          <div style={{
            ...
            border: '1px solid var(--outline-variant)',
            boxShadow: '0 4px 24px rgba(21,51,40,0.06)',
          }}>
            <h2 style={{
              fontFamily: 'var(--font-eb-garamond)',
      ...
      <style>{`
        ...
        .contact-input:focus {
          border-color: var(--sage-green-tint);
          box-shadow: 0 0 0 3px rgba(184, 204, 183, 0.25);
        }
