...
<p>Programs like this one — consistent strength work plus steady habits — are what the research actually supports for postpartum women: better core function, fewer pelvic-floor symptoms, more energy, and, if weight loss is one of your goals, a sustainable <strong>½–1 pound per week</strong>.</p>
...
<div class="card">
  ...
  <p><strong>Why it matters now:</strong> greens bring folate, vitamin K, and iron — the exact stores pregnancy and birth draw down hardest.</p>
...
<div class="card">
  ...
  <p><strong>Why it matters now:</strong> healthy fats, vitamin E, and magnesium — steady, slow-burning energy for broken-sleep days, and building blocks for your hormones.</p>
...
`,
  ...
  // ── 3 · NOURISH PHASE 2 ───────────────────────────────────────────────────
  {
    ...
    body: `
<p>Phase 1 is running on autopilot? Beautiful. Phase 2 adds the three nutrients that do the heaviest lifting in postpartum recovery — and if you're nursing, the ones your baby is drawing from you daily.</p>
...
`,
  ...
  // ── 4 · NOURISH PHASE 3 ───────────────────────────────────────────────────
  {
    ...
    body: `
<p>Water is unglamorous, so it gets skipped. But mild dehydration reads as fatigue, headaches, brain fog, and cranky digestion — everything the newborn season already serves you for free. And if you're nursing, roughly 87% of what you make every day is water.</p>
...
<p>This plan assumes your physician or midwife has cleared you for exercise — typically at the six-week visit, often 8–10+ weeks after a cesarean or a complicated delivery. Gentle walking, the breathing work, and the Daily Dose below are appropriate almost immediately for most women, but the strength plan waits for clearance. When in doubt, ask; it's one question at one appointment.</p>
...
<div class="note"><p><strong>Every day this week:</strong> the Daily Dose (pelvic floor 3 × 8 + quick flicks, and a walk — even 10 minutes).</p></div>
${foundationFive('lying on your back')}
...
${dayTable('Day 3 · Full Body & Carry', [
  ['Romanian deadlift', 4, '10'],
  ['Reverse lunge — quicker up-tempo', 3, '10 / side'],
...
<div class="card tint">
  <ul style="margin:0 0 0 22px;">
    ...
    <li><strong>The food phases are already yours.</strong> Berries to water — that's not a program anymore, that's how you eat.</li>
  </ul>
</div>
